...
const MODAL_MAESTROS = {
    ...
    fields: [
        ...
        { label: 'Teléfono Principal', name: 'telefonoPrincipal', type: 'text' },
        { label: 'Teléfono Secundario', name: 'telefonoSecundario', type: 'text' },
        { label: 'Correo Principal', name: 'emailPrincipal', type: 'text' },
        { label: 'Correo Secundario', name: 'emailSecundario', type: 'text' },
        { label: 'Rol', name: 'rol', type: 'select', options: [{ value: 'admin', text: 'Administrador' }, { value: 'user', text: 'Usuario' }]}
    ],
    onSubmit: (formData) => {
...
const MODAL_PAISES = {
    title: 'Agregar País',
    fields: [
        { label: 'ID País', name: 'idPais', type: 'text' },
...
const MODAL_ESTADOS = {
    ...
    fields: [
        { label: 'ID Estado', name: 'idEstado', type: 'text' },
...
const MODAL_MUNICIPIOS = {
    ...
    fields: [
        { label: 'ID Municipio', name: 'idMunicipio', type: 'text' },
...
const MODAL_PARROQUIAS = {
    ...
    fields: [
        { label: 'ID Parroquia', name: 'idParroquia', type: 'text' },
...
const MODAL_ESTUDIANTES = {
    ...
    fields: [
        ...
        { label: 'Apellido', name: 'apellidoPersona', type: 'text' },
        { label: 'Cédula', name: 'cedulaPersona', type: 'text' },
        { label: 'Nombre del Representante', name: 'nombreRepresentante', type: 'text' },
        { label: 'Sexo', name: 'sexoPersona', type: 'text' },
        { label: 'Ciudad', name: 'nombreCiudad', type: 'text' },
        { label: 'Teléfono Principal', name: 'telefonoPrincipal', type: 'text' },
        { label: 'Teléfono Secundario', name: 'telefonoSecundario', type: 'text' },
...
const MODAL_INSCRIPCIONES = {
    ...
    fields: [
        ...
        { label: 'Fecha de Inscripción', name: 'fechaInscripcion', type: 'date' },
...
const FIELDS_MUNICIPIOS = ["idMunicipio", "nombreMunicipio", "nombreEstado", "nombrePais"];
const FIELDS_PARROQUIAS = ["idParroquia", "nombreParroquia", "nombreMunicipio", "nombreEstado", "nombrePais"];
const FIELDS_CIUDADES = ["idCiudad", "nombreCiudad", "nombreParroquia", "nombreMunicipio", "nombreEstado", "nombrePais"];
